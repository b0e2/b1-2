...
insert into public.study_logs
  (title, subject, study_date, duration_minutes, understanding, content, reflection, resource_url, is_completed)
values
  ('useEffect 의존성 배열 정리', 'React', current_date - 2, 90, 4,
  ...
  ('PostgreSQL 제약조건', 'Database', current_date - 1, 60, 3,
   'check 제약으로 값의 범위와 조건부 필수 규칙을 어디까지 표현할 수 있는지 확인했다.',
   null, null, false),

  ('React Router 중첩 라우트', 'React', current_date, 45, 5,
